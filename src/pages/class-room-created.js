...
const ClassRoomCreated = ({ creatingClass, joiningClass }) => {
    ...
    <Layout>
      <div className='w-[100%] px-[10%] h-[100vh] flex justify-center items-center'>
        <div className='text-center mt-[-50px]'>
          ...
          <span className='text-black text-[90px]'>Classroom</span><br/> Successfully Created
          </h1>
...
export default ClassRoomCreated